  ...
  return (
    <div className="container mx-auto px-6">
      <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 lg:mb-20 gap-8">
        <div>
          <h3 className="text-solfil-orange font-black tracking-[0.4em] text-[10px] mb-6 uppercase">TESTEMUNHOS</h3>
          <h2 className="text-5xl lg:text-7xl font-light text-solfil-black uppercase tracking-tighter leading-none">
            FALAM <span className="font-semibold italic">POR NÓS</span><span className="font-bold text-solfil-orange">.</span>
          </h2>
        </div>
          ...
          <div key={t.id} className="min-w-[320px] md:min-w-[420px] bg-white p-10 rounded-[40px] shadow-sm hover:shadow-2xl transition-all duration-500 border border-gray-100 flex flex-col justify-between group">
            <div className="relative pt-4">
               <div className="relative">
                  ...
                  <p className="text-solfil-gray text-xl leading-relaxed font-light italic mb-10 relative z-10">"{t.quote}"</p>
               </div>
            </div>
            <div className="flex items-center gap-4 border-t border-gray-50 pt-8">
              ...
              <div>
                <h4 className="font-bold text-lg text-solfil-black tracking-tight">{t.name}</h4>
                <p className="text-[10px] text-solfil-orange font-black uppercase tracking-widest">{t.location}</p>
              </div>
            </div>
          </div>
        ))}
